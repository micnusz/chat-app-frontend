  ...
  return (
    <div className="bg-background border-t-2 p-6 lg:p-20 flex flex-col md:grid md:grid-cols-3 gap-y-10 h-fit">
      <div className="p-4">
        ...
        <p className="text-xl leading-7 [&:not(:first-child)]:mt-4 text-muted-foreground max-w-3/4">
      ...
      <div className="p-4">
        <p className="text-xl leading-7 [&:not(:first-child)]:mt-6 text-muted-foreground">
          NAVIGATION
        </p>
        <ul className="text-xl flex flex-col gap-y-2 [&:not(:first-child)]:mt-2 ">
      ...
      <div className="flex flex-col gap-y-2 p-4">
        <span className="text-muted-foreground flex flex-row gap-x-2 items-center scroll-m-20 text-xl font-semibold tracking-tight">
          Website by: <h1 className="text-foreground">Michał Nuszkiewicz</h1>
        </span>
